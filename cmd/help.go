...
// bare command name. Cobra's default lists `view`; this lists `view <id>`, so
// the arguments a verb takes are visible from the parent screen instead of one
// drill-down away. That matters most here because the optional [id] is the
// central rule of the grammar.
